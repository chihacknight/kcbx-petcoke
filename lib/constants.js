...
var TAKE_ACTION_URL = "http://bit.ly/1zMglNC";
define("TAKE_ACTION_URL", TAKE_ACTION_URL);
...
define("alertMessage", {
  "en-US": 'Wind Alert! Avoid petcoke exposure by limiting outdoor activity. Learn more and take action at ' + TAKE_ACTION_URL + '.',
  "es-US": "Alerta de viento! Evite la exposición petcoke al limitar la actividad al aire libre. Obtenga más información y tomar medidas al " + TAKE_ACTION_URL + "."
})